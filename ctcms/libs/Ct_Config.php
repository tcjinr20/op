...
define('Web_Url','www.basezhushou.cn'); //站点域名  
...
define('Web_Title','3CCC视频'); //SEO-标题  
define('Web_Keywords','3CCC视频'); //SEO-Keywords  
define('Web_Description','3CCC视频'); //SEO-description  
define('Web_Skin','default'); //网站默认模板  
define('Admin_QQ','157503886');  //站长QQ  
define('Admin_Mail','admin@ctcms.cn');  //站长EMAIL  
define('Admin_Code','0407');  //后台验证码  
